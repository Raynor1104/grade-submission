...
export const mockGrades: GradeViewModel[] = [
  {
    ...
    course: { id: 1, code: 'JAVA101', subject: 'Java Programming' },
  },
  {
    id: 2,
    score: 'B+',
    student: { id: 2, name: 'Trần Thị B' },
    course: { id: 2, code: 'DBI202', subject: 'Database Systems' },
  },
  {
    id: 3,
    score: '8.5',
    student: { id: 3, name: 'Lê Văn C' },
    course: { id: 3, code: 'SWT301', subject: 'Software Testing' },
  },
  {
    id: 4,
    score: 'Pass',
    student: { id: 4, name: 'Phạm Minh D' },
    course: { id: 4, code: 'NET205', subject: 'Computer Networks' },
  },
  {
    id: 5,
    score: 'A-',
    student: { id: 5, name: 'Hoàng Lan E' },
    course: { id: 5, code: 'SE302', subject: 'Software Engineering' },
  },
  {
    id: 6,
    score: 'B',
    student: { id: 6, name: 'Sakura Ito' },
    course: { id: 6, code: 'UIX210', subject: 'UX Fundamentals' },
  },
  {
    id: 7,
    score: '7.8',
